...
{
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "Error: jump condition isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
// if ignoreFirstParam is true, it skips 1 parameter (used by functions that have the 1st parameter as an object)
void call_decompile(char* functionName, bool hasPrecodepos, DWORD _numOfParameters, bool methodCall, bool threadCall, bool resultUnused)
{
	...
	if (methodCall)
	{
		if (StackGetLastValueType() != type_decompiled_string)
		{
			cout << "Error: method object of " << functionName << " isn't of type type_decompiled_string" << endl;
			cin.get();
			ExitProcess(-1);	
		}
	...
	if (numOfParameters) // if the function has parameters
	{
		...
		for (DWORD i = 0; i < numOfParameters; i++)
		{
			if (StackGetLastValueType() != type_decompiled_string)
			{
				cout << "Error: parameter number " << i << " of " << functionName << " isn't of type type_decompiled_string" << endl;
				cin.get();
				ExitProcess(-1);
			}
...
void operator_decompile(char* _operator)
{
	if (StackGetValueType(1) != type_decompiled_string)
	{
		cout << "Error: first operator of \"" << _operator << "\" isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
	else if (StackGetValueType(0) != type_decompiled_string)
	{
		cout << "Error: second operator of \"" << _operator << "\" isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}

	char* OperateString = MallocAndSprintf("%s%s%s", StackGetValue(1), _operator, StackGetValue(0));

	StackPop();
	StackSet<char*>(OperateString, type_decompiled_string);
}
...
BYTE* OP_Return_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "Error: value to return " << "isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
BYTE* OP_EvalArray_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetValueType(0) != type_decompiled_string)
	{
		cout << "OP_EvalArray error: array string 0 isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
	else if (StackGetValueType(1) != type_decompiled_string)
	{
		cout << "OP_EvalArray error: array string 1 isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
BYTE* OP_EvalArrayRef_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "OP_EvalArrayRef error: array string isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
BYTE* OP_SetVariableField_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "Variable field " << VariableNameBuffer << " isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
BYTE* OP_BoolNot_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "Variable where OP_BoolNot is going to be applied isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
...
BYTE* OP_size_Decompile(DWORD gscBuffer, BYTE* opcodesPtr)
{
	...
	if (StackGetLastValueType() != type_decompiled_string)
	{
		cout << "Error: variable for .size isn't of type type_decompiled_string" << endl;
		cin.get();
		ExitProcess(-1);
	}
